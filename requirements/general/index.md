...
[Image of PEST analysis framework]
:** Инструмент оценки внешней среды (Politics, Economics, Socio-culture, Technology).
* **DFD (Data Flow Diagrams) 

[Image of Data Flow Diagram components]
:** Графическое представление потоков данных. Состоит из: *Процессов* (преобразование), *Внешних сущностей* (участники), *Хранилищ данных* (БД) и самих *Потоков* (маршрутов).
