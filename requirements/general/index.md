...
![Требования](pics/requirementswork.png)
...
* **Specific (Конкретная):** Точный ответ на вопрос «Что делать?». Подразумевает один конкретный результат.
...
### Vision & Scope (V&S)
Документ, формируемый на начальных этапах. Содержит общее видение системы и ее границы. Согласуется владельцем продукта (PO) или стейкхолдерами.
* **Структура V&S:**
  1. *Бизнес-требования:* Предпосылки, возможности, цели, метрики успеха, риски.
  2. *Видение решения:* Описание работы, главные фичи, допущения и зависимости.
  3. *Объем и ограничения:* Объем первого релиза, последующих релизов, исключения.
  4. *Бизнес-контекст:* Профили заинтересованных лиц, приоритеты, особенности развертывания.
...
* **Риск:** Негативное событие, которое может произойти или нет. Бывает низким, средним, высоким. В отличие от *проблемы*, риск — это то, что еще не случилось.
