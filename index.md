...
- [SWOT](/requirements/swot/index.md)
...
- [МК паттерны](/architecture/mk-patterns/)
- [OAuth 2.0](/architecture/oauth2/)
- [Domain-Driven Design](/architecture/ddd/)
- [Event-driven архитектура](/architecture/event-driven/)
...
- [Масштабирование](/databases/scaling/)
- [Нормализация](/databases/normalization/)
- [Архитектуры данных](/databases/data-architectures/)
- [Индексы](/databases/indexes/)
...
- [Диаграмма Use Case](/uml/use-case-diagram/)
